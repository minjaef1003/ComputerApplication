...
// 보유 계좌를 보여주는 함수
var showAccount = function(callback) {
...
// 계좌 목록 라우팅 함수
var showaccount = function(req, res) {
    console.log('/process/showaccount 호출됨.');
    
    // pool 객체가 초기화된 경우, showAccount 함수 호출하여 계좌 목록 전송
    if (pool) {
        showAccount(function(err, accountList) {
            if (err) {
...
module.exports.showaccount = showaccount;