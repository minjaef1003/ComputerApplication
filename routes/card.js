...
connection.connect();
var request_receiver = function (req, res) {
...
var outname;
var birth;
var search_show = function (req, res) {
...
var regist_complete = function (req, res) {
...
var pass_regist_complete = function (req, res) {
...
var pass_change_complete = function (req, res) {
    var name = req.body.regist_name;
    var birth = req.body.regist_birthday;
    var card = req.body.regist_cardname;
...
var password_regist = function (req, res) {
    res.render('password_regist');
}
var password_change = function (req, res) {
    res.render('password_change');
}
var card = function (req, res) {
    res.render('card');
}
var card_request = function (req, res) {
    res.render('card_request');
}
var card_search = function(req,res){
    res.render('card_search');
}
var card_regist = function (req, res) {
    res.render('card_regist');
}
var card_password = function (req, res) {
    res.render('card_password');
}
module.exports.request_receiver = request_receiver;
module.search_show = search_show;
module.regist_complete = regist_complete;
module.pass_regist_complete = pass_regist_complete;
module.pass_change_complete = pass_change_complete;
module.password_regist = password_regist;
module.password_change = password_change;
module.card = card;
module.card_request = card_request;
module.card_search = card_search;
module.card_regist = card_regist;
module.card_password = card_password;